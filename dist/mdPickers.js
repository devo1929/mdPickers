...
function TimePickerCtrl($scope, $mdDialog, time, autoSwitch, autoClose, $mdMedia) {
	var self = this;
    this.VIEW_HOURS = 1;
    this.VIEW_MINUTES = 2;
            ...
            var onEvent = function(event) {
                ...
                $timeout(function() {
                    ...
                    if(ctrl.autoClose &&
                        ...
                        timepickerCtrl &&
                        timepickerCtrl.currentView === timepickerCtrl.VIEW_MINUTES) {
...
module.provider("$mdpTimePicker", function() {
    ...
    this.$get = ["$mdDialog", function($mdDialog) {
        var timePicker = function(time, options) {
            ...
            return $mdDialog.show({
                controller:  ['$scope', '$mdDialog', 'time', 'autoSwitch', 'autoClose', '$mdMedia', TimePickerCtrl],
                            ...
                            '<md-dialog-content layout-gt-xs="row" layout-wrap>' +
                                ...
                                '<div>' +
                                    '<div class="mdp-clock-switch-container" ng-switch="timepicker.currentView" layout layout-align="center center">' +
	                                    ...
	                                    '<mdp-clock class="mdp-animation-zoom" auto-switch="timepicker.autoSwitch" auto-close="timepicker.autoClose" time="timepicker.time" type="minutes" ng-switch-when="2"></mdp-clock>' +
                                    '</div>' +
